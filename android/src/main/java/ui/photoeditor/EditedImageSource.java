...
public class EditedImageSource extends ImageSource {
    ...
    public EditedImageSource(Context context, String source) {
      this(context, source, null);
    }

    public EditedImageSource(Context context, String source, @Nullable Headers headers) {
      this(context, source, 0.0d, 0.0d, headers);
    }

    public EditedImageSource(Context context, String source, double width, double height, @Nullable Headers headers) {
    ...
    public boolean isBase64Resource() {
      return mUri != null && EditedImageSource.isBase64Uri(mUri);
    }

    public boolean isResource() {
      return mUri != null && EditedImageSource.isResourceUri(mUri);
    }

    public boolean isLocalFile() {
      return mUri != null && EditedImageSource.isLocalFileUri(mUri);
    }

    public boolean isContentUri() {
      return mUri != null && EditedImageSource.isContentUri(mUri);
    }
